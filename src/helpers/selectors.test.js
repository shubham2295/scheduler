...
test("getAppointmentsForDagetInterviewersForDay returns an array with a length matching the number of interviews for that day", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(result.length).toEqual(2);
});

test("getAppointmentsForDagetInterviewersForDay returns an array containing the correct interviewer objects", () => {
